...
$theme_sn= "MMELocalTheme";
//Theme's short name for adding options to database
$remote_file = "http://demourls.biz/theme-version.txt"; 
//Address of remote file with version number
$update_check_int = 24; 
// Time in hours to check file for new version
$new_version = file_get_contents($remote_file); 
$theme_update_notice ="<p>New theme version ".$new_version." available.Please visit here for the <a href='http://demourls.biz/dentist.zip'>download</a>.</p>";
...
function theme_compare_ver() {
	...
	global $remote_file, $local_version,$theme_sn,$remote_version;
